...
//void Renderer::sphererender(Sphere* src_sphere)
//{
//	// Clear the screen
//	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
//
//	// Use our shader
//	glUseProgram(src_sphere->programID);
//
//	// Compute the MVP matrix from keyboard and mouse input
//	glm::mat4 ProjectionMatrix = glm::perspective(glm::radians(45.0f), 4.0f / 3.0f, 0.1f, 100.0f);
//	// Camera matrix
...
//	// Send our transformation to the currently bound shader,
//	// in the "MVP" uniform
//	glUniformMatrix4fv(src_sphere->MatrixID, 1, GL_FALSE, &MVP[0][0]);
//	glUniformMatrix4fv(src_sphere->ModelMatrixID, 1, GL_FALSE, &ModelMatrix[0][0]);
//	glUniformMatrix4fv(src_sphere->ViewMatrixID, 1, GL_FALSE, &ViewMatrix[0][0]);
//
//	glm::vec3 lightPos = glm::vec3(0, 10, 0);
//	glUniform3f(src_sphere->LightID, lightPos.x, lightPos.y, lightPos.z);
//
//	/*glm::vec3 lightPos2 = glm::vec3(0, 0, 10);
//	glUniform3f(src_obj->LightID2, lightPos2.x, lightPos2.y, lightPos2.z);*/
//
//	// Bind our texture in Texture Unit 0
//	glActiveTexture(GL_TEXTURE0);
//	glBindTexture(GL_TEXTURE_2D, src_sphere->Texture);
//	// Set our "myTextureSampler" sampler to use Texture Unit 0
//	glUniform1i(src_sphere->TextureID, 0);
//
//	// 1rst attribute buffer : vertices
//	glEnableVertexAttribArray(0);
//	glBindBuffer(GL_ARRAY_BUFFER, src_sphere->vertexbuffer);
//	glVertexAttribPointer(
//		0,                  // attribute
//		3,                  // size
//		GL_FLOAT,           // type
...
//	// 2nd attribute buffer : UVs
//	glEnableVertexAttribArray(1);
//	glBindBuffer(GL_ARRAY_BUFFER, src_sphere->uvbuffer);
//	glVertexAttribPointer(
//		1,                                // attribute
//		2,                                // size
//		GL_FLOAT,                         // type
...
//	// 3rd attribute buffer : normals
//	glEnableVertexAttribArray(2);
//	glBindBuffer(GL_ARRAY_BUFFER, src_sphere->normalbuffer);
//	glVertexAttribPointer(
//		2,                                // attribute
//		3,                                // size
//		GL_FLOAT,                         // type
...
//
//	// Draw the triangles !
//	glDrawArrays(GL_TRIANGLES, 0, src_sphere->vertices.size());
//
//	glDisableVertexAttribArray(0);
//	glDisableVertexAttribArray(1);
//	glDisableVertexAttribArray(2);
...
glm::mat4 Renderer::getPosition(glm::mat4 Model, RenderableObject* _obj)
{
	...
	x = _obj->OBJPosition_x;
	y = _obj->OBJPosition_y;
	z = _obj->OBJPosition_z;
